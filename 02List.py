...
list1.remove(99) #처음으로 나오는 항목 99 삭제
print('remove()=>', list1)
...
'''
    표현식(n의 제곱) 반복문(0~9까지 반복) 조건식(3의배수)
    => 0~9까지의 정수중 3의 배수의 제곱을 리스트에 초기화한다.
'''
